...
- **[TODO: Git](src/git)** - Tools to read, search, and manipulate Git repositories
- **[TODO: Memory](src/memory)** - Knowledge graph-based persistent memory system
- **[TODO: Sequential Thinking](src/sequentialthinking)** - Dynamic and reflective problem-solving through thought sequences
...
Managed by WeMake, but built together with the community. The Model Context Protocol is open source and we encourage everyone to contribute their own servers and improvements!
