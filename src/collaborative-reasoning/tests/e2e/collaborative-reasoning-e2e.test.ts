...
describe('Collaborative Reasoning E2E Tests', () => {
  ...
  describe('Complete Workflow Scenarios', () => {
    test('should handle full collaborative reasoning session from start to finish', () => {
        ...
        contributions: [
          {
            ...
            content: 'We need to understand the current pain points in the user journey. Our recent usability tests show users struggle with the checkout process.',
            type: 'observation',
            confidence: 0.85
          }
        ],
      ...
      const informationGatheringData: CollaborativeReasoningData = {
        ...
        contributions: [
          ...problemDefinitionData.contributions,
          {
            ...
            content: 'Looking at our analytics, we have a 68% cart abandonment rate, with 45% dropping off at the payment step. Mobile conversion is 23% lower than desktop.',
            type: 'insight',
            confidence: 0.92
          },
          {
            personaId: 'product-manager',
            content: 'Our customer support tickets show recurring complaints about slow page load times and confusing navigation. We receive about 150 checkout-related tickets per week.',
            type: 'observation',
            confidence: 0.88
          }
        ]
      ...
      const analysisData: CollaborativeReasoningData = {
        ...
        contributions: [
          ...
          {
            personaId: 'ux-designer',
            content: 'The data confirms our UX hypothesis. The checkout flow has too many steps and lacks clear progress indicators. Mobile users face additional friction with form inputs.',
            type: 'synthesis',
            confidence: 0.87
          },
          {
            personaId: 'data-analyst',
            content: 'Cross-referencing with our A/B test data, simplified checkout flows show 34% better conversion rates. However, we need to balance simplicity with security requirements.',
            type: 'insight',
            confidence: 0.91
          }
        ],
      ...
      const solutionGenerationData: CollaborativeReasoningData = {
        ...
        contributions: [
          ...
          {
            personaId: 'product-manager',
            content: 'I propose a phased approach: Phase 1 - optimize mobile checkout forms, Phase 2 - implement guest checkout, Phase 3 - redesign full checkout flow with progress indicators.',
            type: 'suggestion',
            confidence: 0.83
          },
          {
            personaId: 'ux-designer',
            content: 'We should also consider implementing auto-fill capabilities and social login options to reduce friction. A one-page checkout could increase mobile conversions significantly.',
            type: 'suggestion',
            confidence: 0.89
          },
          {
            personaId: 'data-analyst',
            content: 'Based on industry benchmarks, these changes could potentially increase conversion by 15-25%. We should set up proper tracking to measure impact at each phase.',
            type: 'insight',
            confidence: 0.86
          }
        ]
      ...
      const consensusBuildingData: CollaborativeReasoningData = {
        ...
        contributions: [
          ...
          {
            personaId: 'ux-designer',
            content: 'I agree with the phased approach. It allows us to validate improvements incrementally while managing technical risk.',
            type: 'synthesis',
            confidence: 0.92
          },
          {
            personaId: 'data-analyst',
            content: 'The phased rollout will give us better data to optimize each step. I recommend A/B testing each phase with proper statistical significance.',
            type: 'suggestion',
            confidence: 0.94
          },
          {
            personaId: 'product-manager',
            content: 'Consensus reached. We\'ll proceed with the three-phase checkout optimization, starting with mobile form improvements in Q1.',
            type: 'synthesis',
            confidence: 0.95
          }
        ],
    ...
    test('should handle complex multi-persona disagreement resolution', () => {
        ...
        contributions: [
          {
            ...
            content: 'Our AI models can process 10,000 posts per minute with 94% accuracy. Human moderators can only handle 50 posts per hour. The scale difference is undeniable.',
            type: 'insight',
            confidence: 0.95
          },
          {
            personaId: 'content-moderator',
            content: 'AI misses crucial context, cultural nuances, and sarcasm. That 6% error rate represents thousands of wrongly moderated posts daily, damaging user trust.',
            type: 'concern',
            confidence: 0.88
          },
          {
            personaId: 'legal-counsel',
            content: 'Automated systems create liability risks. If AI makes discriminatory decisions, we face regulatory scrutiny. Human oversight provides legal defensibility.',
            type: 'concern',
            confidence: 0.91
          },
          {
            personaId: 'product-owner',
            content: 'User complaints about moderation decisions have increased 40% since full automation. We need to balance efficiency with user satisfaction.',
            type: 'observation',
            confidence: 0.87
          }
        ],
      ...
      const mentionCounts = personaNames.map(name => 
        (responseText.toLowerCase().match(new RegExp(name, 'g')) || []).length
      );
    ...
    test('should handle enterprise decision-making scenario', () => {
      const enterpriseScenario: CollaborativeReasoningData = {
        ...
        contributions: [
          {
            personaId: 'ceo',
            content: 'Our competitors are using hybrid models to attract top talent. We risk losing our best people if we mandate full office return. Flexibility is now a competitive advantage.',
            type: 'insight',
            confidence: 0.88
          },
          {
            personaId: 'hr-director',
            content: 'Employee surveys show 78% prefer hybrid work. Productivity metrics remained stable during remote work. However, new employee onboarding and mentorship suffer remotely.',
            type: 'observation',
            confidence: 0.91
          },
          {
            personaId: 'cfo',
            content: 'Hybrid model could reduce office space costs by 30-40%. However, we need to invest in collaboration technology and may face coordination overhead costs.',
            type: 'insight',
            confidence: 0.85
          },
          {
            personaId: 'tech-lead',
            content: 'Development teams are more productive remotely - fewer interruptions, flexible hours. But cross-team collaboration and innovation sessions work better in person.',
            type: 'observation',
            confidence: 0.87
          }
        ],
        ...
        contributions: [
          {
            ...
            content: 'Our monolith is reaching scalability limits. Database bottlenecks and deployment coupling slow us down. Microservices would enable independent scaling and team autonomy.',
            type: 'insight',
            confidence: 0.89
          },
          {
            personaId: 'devops-engineer',
            content: 'Microservices introduce significant operational complexity. We\'d need service mesh, distributed tracing, and sophisticated monitoring. Our current team may not be ready.',
            type: 'concern',
            confidence: 0.92
          },
          {
            personaId: 'product-manager',
            content: 'Migration would slow feature delivery for 6-9 months. We\'re in a competitive market where speed matters. Can we achieve our goals with targeted monolith optimizations?',
            type: 'challenge',
            confidence: 0.86
          }
        ],
